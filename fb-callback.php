...
$tokenMetadata->validateAppId('199274320631358'); // Replace {app-id} with your app id
...
$_SESSION['fb_access_token'] = (string) $accessToken;  $response = $fb->get('/me?fields=id,name', $_SESSION['fb_access_token']);
