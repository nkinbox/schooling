<?php include_once('config.php');
	...
	$check=mysqli_query($con,"SELECT `id`, `school_id`, `name`, `school_gender`, `school_region`, `service_fee`, `schoolimg`, `alert_fee`, `address`, `status`, `created_at`, `updated_at` FROM `tbl_school`");
