    ...
    <section class="content">
      ...
      <div class="box">
             ...
             ?>
              ...
              <h3 class="box-title">Offers</h3><br><br>
              <a class="btn btn-primary" href="add_offer.php">Add Offers</a>
                  ...
                  <tbody>
                   <?php 
                      ...
                      <tr>
                        ...
                        <td ><?php echo isset($row['discount_percent'])?$row['discount_percent']:''; ?></td>
                    
                        <td><?php echo isset($row['created_at'])?$row['created_at']:''; ?></td>
                        <td>
                       
                        <a href="add_offer.php?edit_id=<?php echo $row['id']; ?>" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;
...
function setDeleteAction() {
  ...
  document.donorfrm.action = "delete_offer.php";
