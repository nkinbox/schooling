...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
              ...
              <h3 class="box-title"> Outstation Car List</h3><br><br>
              <a class="btn btn-primary" href="add-outstation-car.php">Add New</a>
            ...
            <?php  } ?>
              ...
              <div class="divchange">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                   <?php 
                      $rowdata=$GFH_Admin->getOutstationCar();
                      $i=1;
                      ...
                      <tr>
                        ...
                        <a href="add-outstation-car.php?edit_id=<?php echo $row['id']; ?>" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;
...
function setDeleteAction() {
  ...
  document.donorfrm.action = "delete_outstation_car.php";
