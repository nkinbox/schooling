...
<div id="profile-section" class="text-center">
 ...
 <div class="container text-center">
   <?php  $pages=$GFH_Admin->getPages('8');
     ...
     ?>
    <a href="images/page/<?php echo isset($pag['page_image'])?$pag['page_image']:'';  ?>" style="color:#fff;" class="btn btn_doc" target="_blank"><?php echo isset($pag['page_name'])?$pag['page_name']:'';  ?></a>
 </div>
<div id="round">
<div class="container">
